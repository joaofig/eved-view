...
from app.viewmodels.map import RemoveCircleCommand
...
class CirclePropertyEditor(ui.column, Observer):
    ...
    def observable(self, observable: Observable | None):
        if observable is None:
            if self._observable is not None:
                ...
                self._fill_input.unbind("fill", self._observable)
        ...
        if observable is not None:
            ...
            self._fill_input.bind(observable, "fill", "value")
    ...
    @property
    def remove_command(self) -> RemoveCircleCommand | None:
        return self._remove_command

    @remove_command.setter
    @notify_change
    def remove_command(self, remove_command: RemoveCircleCommand | None):
